DROP TABLE IF EXISTS Ressource, Film, Livre, Musique, Exemplaire, Personne, Adherent, Personnel, Deterioration, Retard, Pret, Interprete, Compositeur, Auteur, Realisateur, Acteur;
